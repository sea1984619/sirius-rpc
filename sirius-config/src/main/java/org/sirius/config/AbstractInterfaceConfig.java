...
import static org.sirius.config.RpcConfigs.getBooleanValue;
import static org.sirius.config.RpcConfigs.getStringValue;
import static org.sirius.config.RpcOptions.DEFAULT_GROUP;
import static org.sirius.config.RpcOptions.DEFAULT_PROXY;
import static org.sirius.config.RpcOptions.DEFAULT_SERIALIZATION;
import static org.sirius.config.RpcOptions.DEFAULT_UNIQUEID;
import static org.sirius.config.RpcOptions.DEFAULT_VERSION;
import static org.sirius.config.RpcOptions.SERVICE_REGISTER;
import static org.sirius.config.RpcOptions.SERVICE_SUBSCRIBE;
