...
public class ProxyUtil {
	   ...
	   private static final AtomicLong PROXY_CLASS_COUNTER = new AtomicLong(0);
	    private static final String PACKAGE_NAME = ProxyUtil.class.getPackage().getName();
	    ...
	    public static Object getProxy(Invoker invoker ,Class<?>... ics) {
	        return getProxy(ClassHelper.getClassLoader(ProxyUtil.class),invoker, ics);
	    }
	        ...
	        try {
	            ...
	            for (int i = 0; i < ics.length; i++) {
	                ...
	                for (Method method : ics[i].getMethods()) {
	                    ...
	                    code.append(" Object ret = invoker.invoke(methods[").append(ix).append("], args);");
	            ...
	            ccp.addConstructor(Modifier.PUBLIC, new Class<?>[]{Invoker.class}, new Class<?>[0], "invoker=$1;");
