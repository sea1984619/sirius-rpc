...
import org.sirius.common.util.Pow2;
...
public class DisruptorExecutor implements InnerExecutor {
	...
	public DisruptorExecutor(int numWorkers, ThreadFactory threadFactory) {
	        this(numWorkers, threadFactory, BUFFER_SIZE, WaitStrategyType.BLOCKING_WAIT);
	    }
	public DisruptorExecutor(int numWorkers, ThreadFactory threadFactory, int bufSize,
	        ...
	        try {
	            ...
	            try {
	        	 ...
	        	 if (logger.isWarnEnabled()) {
	                 logger.warn("Disruptor  InsufficientCapacityException ..................");
	             }
	        }
